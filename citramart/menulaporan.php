...
<head>
	...
	<link rel="stylesheet" type="text/css" href="menulaporan.css">
...
<body>
	...
	<div class="container">
			...
			<div class="menu" style="text-align: center;">
					<form  action="laporanbarang.php">
						<input type="submit" value="Data Barang">
					</form>
					<form action="laporanpegawai.php">
						<input type="submit" value="Data Pegawai">
					</form>
					<form action="laporankeuangan.php">
						<input type="submit" value="Data Keuangan">
					</form>
			</div>
