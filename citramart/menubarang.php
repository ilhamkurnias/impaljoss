...
<head>
	...
	<link rel="stylesheet" type="text/css" href="menubarang.css">
	...
	<div class="container">
			...
			<div class="menu" style="text-align: center;">
					<form  action="barang.php">
						<input type="submit" value="Pengadaan Barang">
					</form>
					<form action="penjualan.php">
						<input type="submit" value="Penjualan">
					</form>
					<form action="stockopname.php">
						<input type="submit" value="Stok Opname">
					</form>
			</div>
