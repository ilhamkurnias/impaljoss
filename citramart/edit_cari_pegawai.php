...
<head>
	...
	<link rel="stylesheet" type="text/css" href="edit_cari_pegawai.css">
...
<body>
	<div class="sidebar">
				<ul>
					<li><button class="accordion"><a  href="barang.php">Pengelolaan Barang</a></button></li>
	...
	<div class="container">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="kelola_akun.php">Pengelolaan Pegawai dan Akun</a></li>
			  <li><a href="edit_cari_pegawai.php">akun pegawai</a></li>
